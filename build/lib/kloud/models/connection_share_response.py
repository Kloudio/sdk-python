...
class ConnectionShareResponse(object):
    ...
    def __init__(self, id=None, object=None, shared_with=None):  # noqa: E501
        """ConnectionShareResponse - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._object = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConnectionShareResponse, dict):
