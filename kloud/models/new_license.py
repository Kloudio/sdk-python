...
class NewLicense(object):
    ...
    def __init__(self, first_name=None, last_name=None, email=None, role=None):  # noqa: E501
        """NewLicense - a model defined in Swagger"""  # noqa: E501
